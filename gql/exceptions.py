...
class NotAnEnum(Exception):
    def __init__(self):
        message = "gql.enum can only be used with subclasses of Enum"
...
class MissingReturnAnnotationError(Exception):
    ...
    def __init__(self, field_name: str):
        message = f'Return annotation missing for field "{field_name}", ' "did you forget to add it?"
...
class MissingArgumentsAnnotationsError(Exception):
    ...
    def __init__(self, field_name: str, arguments: Set[str]):
        ...
        message = f"Missing annotation for {argument} " f'in field "{field_name}", did you forget to add it?'
